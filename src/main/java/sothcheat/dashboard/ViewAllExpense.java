...
public class ViewAllExpense extends JPanel {
    ...
    private List<Transaction> allExpenses;
    ...
    private void init() {
        ...
        Sidebar sidebar = new Sidebar("ViewAllExpense");
    ...
    private void loadData() {
        allExpenses = transactionService.getTransactionsByUserAndType(currentUser.getUserId(), "expense");
        expenseCategories = categoryService.getCategoriesByUserAndType(currentUser.getUserId(), "expense");
        ...
        displayTransactions(allExpenses);
    }
    ...
    private JPanel createHeader() {
        ...
        JLabel titleLabel = new JLabel("View All Expense");
        titleLabel.putClientProperty(FlatClientProperties.STYLE, "" +
                "font:bold +16;" +
                "foreground:#3D3828");

        JLabel subtitleLabel = new JLabel("You can view and manage all your expense here:");
    ...
    private JPanel createFilterPanel() {
        ...
        filtersPanel.add(dateField, "split2, growx, wmin 120");
    ...
    private JPanel createTablePanel() {
        ...
        expenseTable.getColumnModel().getColumn(4).setCellRenderer(new ActionCellRenderer());
        expenseTable.getColumnModel().getColumn(4).setCellEditor(new ActionCellEditor());
    ...
    private void applyFilters() {
        ...
        List<Transaction> filtered = allExpenses.stream()
                .filter(t -> {
    ...
    private void editTransaction(int transactionId) {
        Transaction transaction = allExpenses.stream()
    ...
    private void showEditTransactionDialog(Transaction transaction) {
        ...
        saveBtn.addActionListener(e -> {
            try {
                ...
                int categoryId = expenseCategories.get(selectedIndex).getCategoryId();
